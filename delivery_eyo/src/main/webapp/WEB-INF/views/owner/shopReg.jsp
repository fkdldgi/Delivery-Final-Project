...
<div id="div_wrap">
	<form id="form_wrap" action="/delivery/owner/shopReg" method="post">
		...
		<div class="form-group under_border">
			...
			<div class="form-check">
				<label class="form-check-label"> <input type="radio"
					class="form-check-input" name="payment_option">만나서결제
				</label>
			</div>
			<div class="form-check">
				<label class="form-check-label"> <input type="radio"
					class="form-check-input" name="payment_option">바로결제
				</label>
			</div>
			<div class="form-check">
				<label class="form-check-label"> <input type="radio"
					class="form-check-input" name="payment_option" checked="checked">만나서결제,바로결제
				</label>
			</div>
		</div>
		<div class="form-group under_border">
			<label for="min_price"><b>최소주문금액</b></label><br> <input
				type="number" min="0" max="100000" step="500" maxlength="6" name="min_price"
				id="min_price" oninput="maxLengthCheck(this)">원
		</div>
		<div class="form-group under_border">
			<label>운영시간</label>
			<div>
		...
		<div class="form-group under_border">
			<label for="mutual_name">가게 상호명</label> <input type="text"
		...
		<!-- 
	  	<div class="form-group under_border">
	  		<label for="delivery_area">배달지역</label>
	  		<input type="text" class="form-control" id="" 
	  			placeholder=" 배달지역" name="" required>
	  	</div>
	  	<div class="form-group under_border">
	  		<label for="">사업자주소</label>
	  		<input type="text" class="form-control" id="" 
	  			placeholder="사업자주소" name="" required>
	  	</div>
	  	<div class="form-group under_border">
	  		<label for="">건물관리번호</label>
	  		<input type="text" class="form-control" id="" 
	  			placeholder="건물관리번호" name="" required>
	  	</div>
	  	<div class="form-group under_border">
	  		<label for="">가게카테고리</label>
	  		<input type="text" class="form-control" id="" 
	  			placeholder="가게카테고리" name="" required>
	  	</div>
	  	<div class="form-group under_border">
	  		<label for="">가게 프로필사진</label>
	  		<input type="text" class="form-control" id="" 
	  			placeholder="가게 프로필사진" name="" required>
	  	</div>
	  	<div class="form-group under_border">
	  		<label for="">가게소개</label>
	  		<input type="text" class="form-control" id="" 
	  			placeholder="가게소개" name="" required>
	  	</div>
	  	<div class="form-group under_border">
	  		<label for="">안내</label>
	  		<input type="text" class="form-control" id="" 
	  			placeholder="안내" name="" required>
	  	</div>
	  	<div class="form-group under_border">
	  		<label for="">휴무일</label>
	  		<div class="row">	  		
	  	...
	  	<div class="form-group under_border">
	  		<label for="">리뷰안내</label>
	  		<input type="text" class="form-control" id="" 
	  			placeholder="리뷰안내" name="" required>
	  	</div>
 -->
		<!-- 
